...
namespace Fast.Framework.Utils
{
    ...
    public static class Timestamp
    {
        ...
        /// <returns></returns>
        public static DateTime SecondsTimestampToDateTime(long timestamp)
        {
            return TimeZoneInfo.ConvertTimeFromUtc(startDate.AddSeconds(timestamp), TimeZoneInfo.Local);
        }
        ...
        /// <param name="timestamp">时间戳</param>
        /// <returns></returns>
        public static DateTime MillisecondsTimestampToDateTime(long timestamp)
        {
            return TimeZoneInfo.ConvertTimeFromUtc(startDate.AddMilliseconds(timestamp), TimeZoneInfo.Local);
        }
    }
}
