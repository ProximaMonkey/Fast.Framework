    ...
    public class ExceptionMiddleware
    {
        ...
        private async Task ExceptionHandlerAsync(HttpContext context, Exception exception)
        {
            if (!context.Response.HasStarted)
            {
                ...
                {
                    await context.Response.WriteAsync($"{{\"Code\":{StatusCode.ArgumentError},\"Message\":\"{exception.Message}\"}}");
                }
                else
                {
                    await context.Response.WriteAsync($"{{\"Code\":{StatusCode.Error},\"Message\":\"{exception.Message}\"}}");
                }
